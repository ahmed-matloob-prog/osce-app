export default {
  ...
  device: {
    ...
    assign: 'تثبيت هذا الجهاز',
    release: 'إلغاء التثبيت',
    releaseTitle: 'إلغاء تثبيت هذا الجهاز',
    releaseSubtitle: 'أدخل الرمز الذي حُدّد عند التثبيت',
    releaseFromHeader: 'استخدم «إلغاء التثبيت» في الشريط الأزرق في الأعلى.',
    pinnedDevice: 'جهاز مثبّت',
    pinLabel: 'رمز إلغاء التثبيت',
    pinPlaceholder: 'رمز إلغاء التثبيت (اختياري)',
    pinHint: 'من ٤ إلى ٦ أرقام. بدونه يكفي ضغطة واحدة لإلغاء التثبيت.',
